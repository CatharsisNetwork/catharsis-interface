    ...
    return (
        <div className={style.chart}>
            ...
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data}
                           margin={{
                               top: 15, right: 20, bottom: 5, left: -10,
                           }}
                >
                    <defs>
                    ...
                    <YAxis
                        ...
                        tick={{stroke: 'rgba(216, 178, 255, 0.64)', strokeWidth: 0.5}}
                    />
                    <CartesianGrid strokeDasharray="10 15" vertical={false} height={2} stroke={"#343434"}/>
                    <Tooltip
                        offset={-27}
                        content={<CustomTooltip payload={data}/>}
                        cursor={{stroke: '#343434', strokeWidth: 1.5}}/>
                    <Area type="monotone" dataKey="pv" stroke="#D8B2FF" fillOpacity={1} fill="url(#colorPv)"/>
                </AreaChart>
            </ResponsiveContainer>
        </div>
    );
