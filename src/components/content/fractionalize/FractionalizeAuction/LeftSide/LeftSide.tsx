	...
	return (
		<div className={style.content_left}>
			<div className={style.percentage}>
				...
				<div
					className={style.percentage_grid}
					style={{
						background: `linear-gradient(to top, #332F40 0%, #332F40 ${slider}% ,  #5469D4 ${slider}%,#5469D4 100%)`,
					}}
				>
			...
			<div className={style.buyout}>
				<div className={style.buyout_card}>
					<BuyoutCard image={ethereum} title={'Fraction price'} value={10984} />
					<BuyoutCard
						image={ethereum}
						title={'Buyout price'}
						value={+(10984 + (10984 * sliderPercentage) / 100).toFixed(0)}
					/>
				</div>

				<div className={style.buyout_slider}>
					<span className={style.buyout_slider__title}>
						You can change buyout price
					</span>
					<Slider
