        ...
        <>
            ...
            <section className={style.position}>
                <MainPageSection
                    ...
                    footer={() => <img src={main_content_action} alt="main_content_action"/>}
                    custom={"action"}
                />
            ...
            <section className={style.position}>
                <MainPageSection
                    title={() => (<span><img src={main_content_flame} alt=""/> Auction</span>)}
            ...
            <section className={style.position}>
                <MainPageSection
                    title={() => (<span><img src={main_content_voting} alt=""/> Voting</span>)}
